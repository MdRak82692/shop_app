...
class QuantityFetchInformation {
  ...
  Future<double> fetchAvailableQuantity(String productName) async {
    Map<String, double> availableQuantities = await fetchAvailableQuantities();
    return availableQuantities[productName] ?? 0.0;
  }
