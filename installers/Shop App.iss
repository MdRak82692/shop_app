...
OutputDir=F:\APP\shop_app\installers
OutputBaseFilename=Shop App
SetupIconFile=F:\APP\shop_app\assets\icons\logo_app.ico
Compression=lzma
...
[Files]
Source: "F:\APP\shop_app\build\windows\x64\runner\Release\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
